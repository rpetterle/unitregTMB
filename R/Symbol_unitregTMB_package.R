...
p <- ggplot() +
  ...
  annotate("text", x = 0, y = -0.45, label = "unitregTMB", color = "#FFFFFF", size = 13, fontface = "bold", family = "sans") +
  annotate("text", x = 0, y = -0.65, label = "Unit Interval Regression", color = "#48CAE4", size = 3.8, family = "sans", fontface = "bold") +
